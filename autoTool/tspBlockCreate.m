function tspBlockCreate(blkhdl, titlename, sfcnname, postfuncname, periname, tlcmode)
...
% tlcmode -- 'initReg', 'fromReg', 'toReg'
% run this function in "HyoCG\cmex_tlc\XXX"
% eg. tspBlockCreate(gcbh, 'RTC START STOP', 'rtcst', '_STARTSTOP', 'RTC', 'toReg')
% Hyowinner @2016/7/11
...
tlcGen(sfcnname, now, postfuncname, periname, 'definition', 'prototype', 'include', tlcmode);
