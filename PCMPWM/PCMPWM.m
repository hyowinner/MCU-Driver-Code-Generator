function uiobj = PCMPWM
% This is the config file for generate UI for PCMPWM
% short for : pcmpwm
sfnName = 'pcmpwm';

index = 1;
% first element is the display string. do not store in S-function
uiobj(index).prompt = 'The PCMPWM module converts Pulse Code Modulated (PCM) data samples to Pulse Width Modulated (PWM) signals.';
uiobj(index).headerfile = 's6j3200_PCMPWM.h';
uiobj(index).periname = 'PCMPWM';               % folder name of the upper layer.
